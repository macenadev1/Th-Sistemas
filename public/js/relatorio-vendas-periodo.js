...
function setarPeriodoRelatorio(tipo, botaoClicado) {
    ...
    document.getElementById('dataInicialRelatorio').value = formatarDataLocal(dataInicial);
    document.getElementById('dataFinalRelatorio').value = formatarDataLocal(dataFinal);
